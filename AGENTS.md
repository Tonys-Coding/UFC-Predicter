...
- Product preferences: decisions shortly before fights; separate statistical and market estimates; all matchups plus better-supported edges; verified dated news without subjective probability adjustments; free sources first. Collect only while the dashboard is open. No background service, combined market model, subscription, or automatic order execution.
